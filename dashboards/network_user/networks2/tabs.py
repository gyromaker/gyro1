...
from openstack_dashboard.dashboards.network_user.networks2.ports import tabs \
    as ports_tabs
from openstack_dashboard.dashboards.network_user.networks2.subnets import tabs \
    as subnets_tabs
from openstack_dashboard.dashboards.network_user.networks2 \
...
class OverviewTab(tabs.Tab):
    ...
    def get_context_data(self, request, **kwargs):
        ...
        #network = api.neutron.network_get(self.request, "00052027-86d6-4100-9b19-5aa4ed3b78e5")
