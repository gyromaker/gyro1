...
from openstack_dashboard.dashboards.network_user.networks2.ports.extensions.\
...
class AddAllowedAddressPair(forms.ModalFormView):
    ...
    template_name = 'network_user/networks2/ports/add_addresspair.html'
    context_object_name = 'port'
    submit_label = _("Submit")
    submit_url = "horizon:network:networks2:ports:addallowedaddresspairs"
    success_url = 'horizon:network:networks2:ports:detail'
