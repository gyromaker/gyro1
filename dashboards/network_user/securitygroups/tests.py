...
from openstack_dashboard.dashboards.network_user.securitygroups import tables


INDEX_URL = reverse('horizon:network:securitygroups:index')
SG_CREATE_URL = reverse('horizon:network:securitygroups:create')

SG_VIEW_PATH = 'horizon:network:securitygroups:%s'
SG_DETAIL_VIEW = SG_VIEW_PATH % 'detail'
SG_UPDATE_VIEW = SG_VIEW_PATH % 'update'
SG_ADD_RULE_VIEW = SG_VIEW_PATH % 'add_rule'

SG_TEMPLATE_PATH = 'network/securitygroups/%s'
...
class SecurityGroupsViewTests(test.TestCase):
    ...
    def test_create_button_attributes(self):
        ...
        url = 'horizon:network:securitygroups:create'
