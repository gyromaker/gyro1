...
from openstack_dashboard.dashboards.network_user.securitygroups \
...
class DetailView(tables.DataTableView):
    ...
    template_name = 'network/securitygroups/detail.html'
    ...
    def _get_data(self):
        ...
        try:
            ...
            redirect = reverse('horizon:network:securitygroups:index')
...
class UpdateView(forms.ModalFormView):
    ...
    template_name = 'network/securitygroups/update.html'
    submit_label = _("Edit Security Group")
    submit_url = "horizon:network:securitygroups:update"
    success_url = reverse_lazy('horizon:network:securitygroups:index')
    ...
    def get_object(self):
        ...
        try:
            ...
            url = reverse('horizon:network:securitygroups:index')
...
class AddRuleView(forms.ModalFormView):
    ...
    template_name = 'network/securitygroups/add_rule.html'
    submit_label = _("Add")
    submit_url = "horizon:network:securitygroups:add_rule"
    url = "horizon:network:securitygroups:detail"
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'network/securitygroups/create.html'
    submit_label = _("Create Security Group")
    submit_url = reverse_lazy(
        "horizon:network:securitygroups:create")
    success_url = reverse_lazy('horizon:network:securitygroups:index')
