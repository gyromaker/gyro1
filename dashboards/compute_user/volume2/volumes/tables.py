...
class LaunchVolumeNG(LaunchVolume):
    ...
    verbose_name = _("Launch as Instance")
    url = "horizon:compute_user:volume2:index"
    classes = ("btn-launch", )
    ajax = False
...
class ExtendVolume(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:extend"
...
class EditAttachments(tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:attach"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class CreateSnapshot(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:create_snapshot"
    classes = ("ajax-modal",)
    icon = "camera"
...
class CreateTransfer(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:create_transfer"
    classes = ("ajax-modal",)
...
class CreateBackup(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:create_backup"
    classes = ("ajax-modal",)
...
class UploadToImage(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:upload_to_image"
    classes = ("ajax-modal",)
    icon = "cloud-upload"
    policy_rules = (("volume",
...
class EditVolume(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class RetypeVolume(VolumePolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:retype"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class AcceptTransfer(tables.LinkAction):
    ...
    url = "horizon:compute_user:volume2:volumes:accept_transfer"
    classes = ("ajax-modal",)
    icon = "exchange"
...
def get_encrypted_link(volume):
    if hasattr(volume, 'encrypted') and volume.encrypted:
        return reverse("horizon:compute_user:volume2:volumes:encryption_detail",
