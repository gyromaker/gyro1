...
class OverviewTab(tabs.Tab):
    name = _("Overview")
    slug = "overview"
    template_name = ("compute/vminstance/"
...
class LogTab(tabs.Tab):
    name = _("Log")
    slug = "log"
    template_name = "compute/vminstance/_detail_log.html"
    preload = False
...
class ConsoleTab(tabs.Tab):
    name = _("Console")
    slug = "console"
    template_name = "compute/vminstance/_detail_console.html"
    preload = False
    ...
    def get_context_data(self, request):
        ...
        try:
            ...
            if console_type == "SERIAL":
                console_url = reverse('horizon:compute:vminstance:serial',
                                      args=[instance.id])
...
class AuditTab(tabs.TableTab):
    ...
    template_name = "compute/vminstance/_detail_audit.html"
    preload = False
