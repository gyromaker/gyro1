...
from openstack_dashboard.dashboards.compute.vminstance import console
from openstack_dashboard.dashboards.compute.vminstance import tables
from openstack_dashboard.dashboards.compute.vminstance import tabs
from openstack_dashboard.dashboards.compute.vminstance import workflows
from openstack_dashboard.test import helpers
from openstack_dashboard.usage import quotas


INDEX_TEMPLATE = 'horizon/common/_data_table_view.html'
INDEX_URL = reverse('horizon:compute:vminstance:index')
...
class VminstanceTests(helpers.ResetImageAPIVersionMixin, helpers.TestCase):
    def setUp(self):
    ...
    def _get_instance_details(self, server, qs=None,
        ...
        url = reverse('horizon:compute:vminstance:detail', args=[server.id])
        if qs:
            url += qs
    ...
    def test_instance_details_console_tab(self):
        ...
        self.assertTemplateUsed(res,
                                'compute/vminstance/_detail_console.html')
    ...
    def test_instance_details_exception(self):
        ...
        url = reverse('horizon:compute:vminstance:detail',
                      args=[server.id])
    ...
    def test_instance_details_flavor_not_found(self):
        ...
        self.assertTemplateUsed(res,
                                'compute/vminstance/_detail_overview.html')
    ...
    def test_instance_log(self):
        ...
        url = reverse('horizon:compute:vminstance:console',
                      args=[server.id])
        tg = tabs.InstanceDetailTabs(self.request, instance=server)
    ...
    def test_instance_vnc(self):
        ...
        url = reverse('horizon:compute:vminstance:vnc',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_spice(self):
        ...
        url = reverse('horizon:compute:vminstance:spice',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def test_instance_rdp(self):
        ...
        url = reverse('horizon:compute:vminstance:rdp',
                      args=[server.id])
        res = self.client.get(url)
        redirect = CONSOLE_URL
        self.assertRedirectsNoFollow(res, redirect)
    ...
    def _test_instances_index_retrieve_password_action(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:compute:vminstance:index')
        res = self.client.get(url)
        for server in servers:
    ...
    def test_decrypt_instance_password(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:compute:vminstance:decryptpassword',
                      args=[server.id,
                            server.key_name])
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'compute/vminstance/decryptpassword.html')
    ...
    def test_instance_update_get(self):
        ...
        url = reverse('horizon:compute:vminstance:update', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_update_get_server_get_exception(self):
        ...
        url = reverse('horizon:compute:vminstance:update',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_launch_instance_get(self,
        ...
        url = reverse('horizon:compute:vminstance:launch')
    ...
    def test_instance_resize_get(self):
        ...
        url = reverse('horizon:compute:vminstance:resize', args=[server.id])
        res = self.client.get(url)
    ...
    def test_instance_resize_get_server_get_exception(self):
        ...
        url = reverse('horizon:compute:vminstance:resize',
                      args=[server.id])
        res = self.client.get(url)
    ...
    def test_rebuild_instance_get(self, expect_password_fields=True):
        ...
        url = reverse('horizon:compute:vminstance:rebuild', args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res, 'compute/vminstance/rebuild.html')
    ...
    def _instance_rebuild_post(self, server_id, image_id,
        ...
        url = reverse('horizon:compute:vminstance:rebuild',
                      args=[server_id])
    ...
    def test_index_form_action_with_pagination(self):
        ...
        next_page_url = "?".join([reverse('horizon:compute:vminstance:index'),
                                  params])
...
class ConsoleManagerTests(helpers.ResetImageAPIVersionMixin, helpers.TestCase):
    ...
    def test_interface_attach_get(self):
        ...
        url = reverse('horizon:compute:vminstance:attach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'compute/vminstance/attach_interface.html')
    ...
    def test_volume_attach_get(self):
        ...
        url = reverse('horizon:compute:vminstance:attach_volume',
                      args=[server.id])
        ...
        self.assertIsInstance(form.fields['volume'].widget,
                              forms.Select)
        self.assertTemplateUsed(res,
                                'compute/vminstance/attach_volume.html')
    ...
    def test_volume_detach_get(self):
        ...
        url = reverse('horizon:compute:vminstance:detach_volume',
                      args=[server.id])
        ...
        self.assertEqual(res.status_code, 200)
        self.assertTemplateUsed(res,
                                'compute/vminstance/detach_volume.html')
    ...
    def test_interface_detach_get(self):
        ...
        url = reverse('horizon:compute:vminstance:detach_interface',
                      args=[server.id])
        res = self.client.get(url)

        self.assertTemplateUsed(res,
                                'compute/vminstance/detach_interface.html')
