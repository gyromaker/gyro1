...
from openstack_dashboard.dashboards.compute.vminstance \
...
def vnc(request, instance_id):
    try:
        ...
        redirect = reverse("horizon:compute:vminstance:index")
...
class SerialConsoleView(generic.TemplateView):
    template_name = 'compute/vminstance/serial_console.html'
...
class UpdateView(workflows.WorkflowView):
    ...
    success_url = reverse_lazy("horizon:compute:vminstance:index")
...
class RebuildView(forms.ModalFormView):
    ...
    template_name = 'compute/vminstance/rebuild.html'
    success_url = reverse_lazy('horizon:compute:vminstance:index')
...
class DecryptPasswordView(forms.ModalFormView):
    ...
    template_name = 'compute/vminstance/decryptpassword.html'
    success_url = reverse_lazy('horizon:compute:vminstance:index')
...
class DetailView(tabs.TabView):
    ...
    redirect_url = 'horizon:compute:vminstance:index'
...
class AttachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'compute/vminstance/attach_interface.html'
    ...
    def get_initial(self):
        ...
        submit_url = "horizon:compute:vminstance:attach_interface"
...
class AttachVolumeView(forms.ModalFormView):
    ...
    template_name = 'compute/vminstance/attach_volume.html'
    ...
    def get_initial(self):
        args = {'instance_id': self.kwargs['instance_id']}
        submit_url = "horizon:compute:vminstance:attach_volume"
        self.submit_url = reverse(submit_url, kwargs=args)
        try:
...
class DetachVolumeView(forms.ModalFormView):
    ...
    template_name = 'compute/vminstance/detach_volume.html'
    ...
    def get_initial(self):
        args = {'instance_id': self.kwargs['instance_id']}
        submit_url = "horizon:compute:vminstance:detach_volume"
        self.submit_url = reverse(submit_url, kwargs=args)
        return {"instance_id": self.kwargs["instance_id"]}
...
class DetachInterfaceView(forms.ModalFormView):
    ...
    template_name = 'compute/vminstance/detach_interface.html'
    ...
    def get_initial(self):
        args = {"instance_id": self.kwargs["instance_id"]}
        submit_url = "horizon:compute:vminstance:detach_interface"
        self.submit_url = reverse(submit_url, kwargs=args)
        return args
