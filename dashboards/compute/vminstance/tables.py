...
from openstack_dashboard.dashboards.compute.vminstance.workflows \
...
class LaunchLink(tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:launch"
...
class LaunchLinkNG(LaunchLink):
    name = "launch-ng"
    url = "horizon:compute:vminstance:index"
    ajax = False
    classes = ("btn-launch", )
...
class EditInstance(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class ConsoleLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:detail"
    classes = ("btn-console",)
...
class ResizeLink(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:resize"
...
class RebuildInstance(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:rebuild"
...
class DecryptInstancePassword(tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:decryptpassword"
...
class AttachVolume(tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:attach_volume"
    classes = ("ajax-modal",)
...
class DetachVolume(AttachVolume):
    ...
    url = "horizon:compute:vminstance:detach_volume"
...
class AttachInterface(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute:vminstance:attach_interface"
...
class DetachInterface(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    classes = ("btn-confirm", "ajax-modal")
    url = "horizon:compute:vminstance:detach_interface"
...
def get_ips(instance):
    template_name = 'compute/vminstance/_instance_ips.html'
    ip_groups = {}
...
def get_flavor(instance):
    if hasattr(instance, "full_flavor"):
        template_name = 'compute/vminstance/_instance_flavor.html'
...
class InstancesTable(tables.DataTable):
    ...
    name = tables.WrappingColumn("name",
                                 link="horizon:compute:vminstance:detail",
