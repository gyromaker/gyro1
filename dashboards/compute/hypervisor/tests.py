...
class HypervisorViewTest(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        res = self.client.get(reverse('horizon:compute:hypervisor:index'))
        self.assertTemplateUsed(res, 'compute/hypervisor/index.html')
    ...
    def test_service_list_unavailable(self):
        ...
        resp = self.client.get(reverse('horizon:compute:hypervisor:index'))
...
class HypervisorDetailViewTest(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        url = reverse('horizon:compute:hypervisor:detail',
                      args=["%s_%s" % (hypervisor.id,
                                       hypervisor.hypervisor_hostname)])
        res = self.client.get(url)
        self.assertTemplateUsed(res, 'compute/hypervisor/detail.html')
