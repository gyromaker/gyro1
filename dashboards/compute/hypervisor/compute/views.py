...
from openstack_dashboard.dashboards.compute.hypervisor.compute \
    import forms as project_forms


class EvacuateHostView(forms.ModalFormView):
    form_class = project_forms.EvacuateHostForm
    template_name = 'compute:hypervisor/compute/evacuate_host.html'
    context_object_name = 'compute_host'
    success_url = reverse_lazy("horizon:compute:hypervisor:index")
...
class DisableServiceView(forms.ModalFormView):
    ...
    template_name = 'compute:hypervisor/compute/disable_service.html'
    context_object_name = 'compute_host'
    success_url = reverse_lazy("horizon:compute:hypervisor:index")
...
class MigrateHostView(forms.ModalFormView):
    ...
    template_name = 'compute:hypervisor/compute/migrate_host.html'
    context_object_name = 'compute_host'
    success_url = reverse_lazy("horizon:compute:hypervisor:index")
