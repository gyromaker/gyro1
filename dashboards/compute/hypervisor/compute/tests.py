...
class EvacuateHostViewTest(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        url = reverse('horizon:compute:hypervisor:compute:evacuate_host',
                      args=[hypervisor])
        res = self.client.get(url)
        self.assertTemplateUsed(res,
                                'compute:hypervisor/compute/evacuate_host.html')
    ...
    def test_successful_post(self):
        ...
        dest_url = reverse('horizon:compute:hypervisor:index')
...
class MigrateHostViewTest(test.BaseAdminViewTests):
    def test_index(self):
        ...
        self.mox.ReplayAll()
        url = reverse('horizon:compute:hypervisor:compute:migrate_host',
                      args=[disabled_service.host])
        res = self.client.get(url)
        self.assertNoMessages()
        self.assertTemplateUsed(res,
                                'compute:hypervisor/compute/migrate_host.html')
...
class DisableServiceViewTest(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        url = reverse('horizon:compute:hypervisor:compute:disable_service',
                      args=[hypervisor])
        res = self.client.get(url)
        template = 'compute:hypervisor/compute/disable_service.html'
