...
class EvacuateHost(tables.LinkAction):
    ...
    url = "horizon:compute:hypervisor:compute:evacuate_host"
...
class DisableService(policy.PolicyTargetMixin, tables.LinkAction):
    ...
    url = "horizon:compute:hypervisor:compute:disable_service"
...
class MigrateMaintenanceHost(tables.LinkAction):
    ...
    url = "horizon:compute:hypervisor:compute:migrate_host"
    action_type = "danger"
