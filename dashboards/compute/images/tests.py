...
from openstack_dashboard.dashboards.compute.images import tables
...
class ImageCreateViewTest(test.BaseAdminViewTests):
    ...
    def test_admin_image_create_view_uses_admin_template(self):
        ...
        self.mox.ReplayAll()
        res = self.client.get(
            reverse('horizon:compute:images:create'))
        self.assertTemplateUsed(res, 'compute/images/create.html')
