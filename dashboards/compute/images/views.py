...
from openstack_dashboard.dashboards.compute.images import forms as project_forms
...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        if filter_first.get('compute.images', False) and \
...
class DetailView(views.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["url"] = reverse('horizon:compute:images:index')
