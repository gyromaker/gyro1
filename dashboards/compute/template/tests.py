...
from openstack_dashboard.dashboards.compute.template import tables
...
class ImageCreateViewTest(test.BaseAdminViewTests):
    ...
    def test_admin_image_create_view_uses_admin_template(self):
        ...
        self.mox.ReplayAll()
        res = self.client.get(
            reverse('horizon:compute:template:create'))
        self.assertTemplateUsed(res, 'compute/template/create.html')
...
class ImagesViewTest(test.BaseAdminViewTests):
    ...
    def test_images_list_get_pagination(self):
        ...
        url = reverse('horizon:compute:template:index')
        ...
        params = "=".join([tables.AdminImagesTable._meta.pagination_param,
                           images[2].id])
        url = "?".join([reverse('horizon:compute:template:index'), params])
        res = self.client.get(url)
