...
from openstack_dashboard.dashboards.compute.template import forms as project_forms
from openstack_dashboard.dashboards.compute.template \
...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        if filter_first.get('compute.template', False) and \
...
class CreateView(views.CreateView):
    template_name = 'compute/template/create.html'
    form_class = project_forms.AdminCreateImageForm
    submit_url = reverse_lazy('horizon:compute:template:create')
    success_url = reverse_lazy('horizon:compute:template:index')
    page_title = _("Create An Image")


class UpdateView(views.UpdateView):
    template_name = 'compute/template/update.html'
    form_class = project_forms.AdminUpdateImageForm
    submit_url = "horizon:compute:template:update"
    success_url = reverse_lazy('horizon:compute:template:index')
...
class DetailView(views.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["url"] = reverse('horizon:compute:template:index')
