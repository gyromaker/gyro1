...
from openstack_dashboard.dashboards.manager.project import workflows
from openstack_dashboard.test import helpers as test
from openstack_dashboard import usage
from openstack_dashboard.usage import quotas


INDEX_URL = reverse('horizon:manager:project:index')
USER_ROLE_PREFIX = workflows.PROJECT_USER_MEMBER_SLUG + "_role_"
GROUP_ROLE_PREFIX = workflows.PROJECT_GROUP_MEMBER_SLUG + "_role_"
PROJECT_DETAIL_URL = reverse('horizon:manager:project:detail', args=[1])
...
class TenantsViewTests(test.BaseAdminViewTests):
    ...
    def test_index(self):
        ...
        self.assertTemplateUsed(res, 'manager/project/index.html')
    ...
    @test.update_settings(FILTER_DATA_FIRST={'manager.project': True})
...
class CreateProjectWorkflowTests(test.BaseAdminViewTests):
    ...
    def test_add_project_get(self):
        ...
        url = reverse('horizon:manager:project:create')
    ...
    def test_add_project_get_with_neutron(self):
        ...
        res = self.client.get(reverse('horizon:manager:project:create'))
...
class UpdateProjectWorkflowTests(test.BaseAdminViewTests):
    ...
    def test_update_project_get(self):
        ...
        url = reverse('horizon:manager:project:update',
                      args=[self.tenant.id])
        res = self.client.get(url)
...
class UsageViewTests(test.BaseAdminViewTests):
    ...
    def _test_usage_csv(self, nova_stu_enabled=True, overview_days_range=None):
        ...
        csv_url = reverse('horizon:manager:project:usage',
...
class DetailProjectViewTests(test.BaseAdminViewTests):
    ...
    def test_detail_view(self):
        ...
        self.assertTemplateUsed(res, 'manager/project/detail.html')
    ...
    def test_membership_list_loads_correctly(self):
        ...
        self.selenium.get("%s%s" %
                          (self.live_server_url,
                           reverse('horizon:manager:project:create')))
