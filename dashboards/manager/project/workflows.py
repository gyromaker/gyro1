...
ADD_USER_URL = "horizon:manager:project:create_user"
...
COMMON_HORIZONTAL_TEMPLATE = "manager/project/_common_horizontal_form.html"
...
class CreateProject(CommonQuotaWorkflow):
    ...
    success_url = "horizon:manager:project:index"
