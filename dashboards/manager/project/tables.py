...
class RescopeTokenToProject(tables.LinkAction):
    ...
    def get_link_url(self, project):
        ...
        # back to this page
        dash_url = reverse("horizon:manager:project:index")
...
class UpdateMembersLink(tables.LinkAction):
    ...
    url = "horizon:manager:project:update"
    classes = ("ajax-modal",)
    icon = "pencil"
...
class UsageLink(tables.LinkAction):
    ...
    url = "horizon:manager:project:usage"
    icon = "stats"
...
class CreateProject(tables.LinkAction):
    ...
    url = "horizon:manager:project:create"
    classes = ("ajax-modal",)
    icon = "plus"
...
class TenantsTable(tables.DataTable):
    name = tables.WrappingColumn('name', verbose_name=_('Name'),
                                 link=("horizon:manager:project:detail"),
    ...
    def get_project_detail_link(self, project):
        ...
        if policy.check((("identity", "identity:get_project"),),
            ...
            return reverse("horizon:manager:project:detail",
                           args=(project.id,))
        return None
