...
from openstack_dashboard.dashboards.manager.project \
...
INDEX_URL = "horizon:manager:project:index"
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'manager/project/index.html'
    ...
    def get_data(self):
        ...
        if policy.check((("identity", "identity:list_projects"),),
            ...
            if filter_first.get('manager.project', False) and len(
                    filters) == 0:
...
class ProjectUsageView(usage.UsageView):
    ...
    template_name = 'manager/project/usage.html'
