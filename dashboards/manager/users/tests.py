...
USERS_INDEX_URL = reverse('horizon:manager:users:index')
USER_CREATE_URL = reverse('horizon:manager:users:create')
USER_UPDATE_URL = reverse('horizon:manager:users:update', args=[1])
USER_DETAIL_URL = reverse('horizon:manager:users:detail', args=[1])
USER_CHANGE_PASSWORD_URL = reverse('horizon:manager:users:change_password',
                                   args=[1])
...
class UsersViewTests(test.BaseAdminViewTests):
    ...
    def test_index(self, with_domain=False):
        ...
        self.assertTemplateUsed(res, 'manager/users/index.html')
    ...
    def test_detail_view(self):
        ...
        self.assertTemplateUsed(res, 'manager/users/detail.html')
    ...
    @test.update_settings(FILTER_DATA_FIRST={'manager.users': True})
