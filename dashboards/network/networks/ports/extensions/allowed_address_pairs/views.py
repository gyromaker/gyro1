...
from openstack_dashboard.dashboards.network.networks.ports.extensions.\
...
class AddAllowedAddressPair(project_views.AddAllowedAddressPair):
    ...
    submit_url = "horizon:network:networks:ports:addallowedaddresspairs"
    success_url = 'horizon:network:networks:ports:detail'
