...
class CreateView(forms.ModalFormView):
    ...
    submit_url = "horizon:network:networks:addport"
    page_title = _("Create Port")
    template_name = 'network/networks/ports/create.html'
    url = 'horizon:network:networks:detail'
...
class DetailView(project_views.DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        port = context["port"]
        network_url = "horizon:network:networks:detail"
        subnet_url = "horizon:network:networks:subnets:detail"
        ...
        context["url"] = \
            reverse('horizon:network:networks:ports_tab', args=[port.network_id])
