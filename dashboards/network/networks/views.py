...
from openstack_dashboard.dashboards.network.networks.agents import tabs \
    as agents_tabs
...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        try:
            ...
            if filter_first.get('network.networks', False) and \
                    not search_opts:
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'network/networks/create.html'
