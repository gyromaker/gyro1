...
from openstack_dashboard.dashboards.network.networks.agents \
...
class AddView(forms.ModalFormView):
    ...
    template_name = 'network/networks/agents/add.html'
    success_url = 'horizon:network:networks:detail'
    failure_url = 'horizon:network:networks:detail'
    submit_url = "horizon:network:networks:adddhcpagent"
