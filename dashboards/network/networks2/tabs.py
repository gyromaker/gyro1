...
from openstack_dashboard.dashboards.network.networks2.ports import tabs \
    as ports_tabs
from openstack_dashboard.dashboards.network.networks2.subnets import tabs \
    as subnets_tabs
from openstack_dashboard.dashboards.network.networks2 \
